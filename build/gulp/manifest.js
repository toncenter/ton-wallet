...
const base = {
    ...
    content_security_policy: "default-src 'none'; script-src 'self'; style-src 'self'; font-src 'self'; img-src 'self' data: https://nft.ton.diamonds/; connect-src https://toncenter.com/api/v2/jsonRPC https://testnet.toncenter.com/api/v2/jsonRPC https://ton.diamonds/api/wallet/diamond_nfts"
};
